---
name: prd-writing
description: PRD（プロダクト要求定義書）を作成・更新する。「要件定義して」「PRDを書いて」「要件書を作りたい」「仕様をまとめて」「機能要件を整理」「ユーザーストーリーを書いて」「KPIを定義」などの依頼時に使用。ビジョン・ペルソナ・KPI・機能要件・非機能要件を具体化して出力。
...
| `references/guide.md` | 品質チェック・レビュー観点 |
